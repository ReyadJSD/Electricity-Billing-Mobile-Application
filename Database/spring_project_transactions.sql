...
CREATE TABLE `transactions` (
  ...
  PRIMARY KEY (`tnxid`),
  UNIQUE KEY `phone_UNIQUE` (`meter_no`)
...
INSERT INTO `transactions` VALUES ('TD-BKASHAE7B4G1E','123451','0176666666666',1065.14),('TD-BKASHWAW3VRDU',NULL,'01765782562',889.66);

...
class _BarChartWidgetState extends State<BarChartWidget> {
  ...
  void initState() {
    super.initState();
    _list.add(Charts(key: "0", value: "2"));
    _list.add(Charts(key: "1", value: "4"));
    _list.add(Charts(key: "2", value: "6"));
    _list.add(Charts(key: "3", value: "8"));
    _list.add(Charts(key: "4", value: "10"));
    _list.add(Charts(key: "5", value: "8"));
    _list.add(Charts(key: "6", value: "4"));
  }
